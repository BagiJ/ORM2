...
void packet_handler(unsigned char* user, const struct pcap_pkthdr* packet_header, const unsigned char* packet_data)
{
	...
	/* NETWORK LAYER - IPV4 */
	// Retrive the position of the ip header
	ip_header* ih;
	...
	// ICMP (Internet Control Messaging Protocol) packets
	...
	// TCP (Transmision control protocol) packets
